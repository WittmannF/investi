#!/usr/bin/env python3
"""
Página do simulador de aportes regulares para o aplicativo multipage.
"""
...
# Título da página
st.title("💰 Simulador de Aportes Regulares")
st.markdown("Simule o crescimento de um investimento com aportes periódicos.")
