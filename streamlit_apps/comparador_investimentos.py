#!/usr/bin/env python3
"""
Aplicativo Streamlit para comparar diferentes tipos de investimentos lado a lado
...
def main():
    """Função principal do comparador de investimentos"""
    st.title("📊 Comparador de Investimentos - investi")
